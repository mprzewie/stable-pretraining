...
def main():
    ...
    data = make_imagenette_data(batch_size=batch_size, num_workers=8, n_global=2, n_local=4)
    ...
    trainer = standard_trainer(callbacks, max_epochs=max_epochs, log_name="swav-vits-inet10")
